...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  _titleBar() {
    return Text(widget.task == null ? "Tambah Tugas" : "Update Tugas",
        style: headingStyle);
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          MyInputField(
            title: "Pengingat",
            hint: "$_selectedRemind lebih awal",
          ...
          Row(
            ...
            children: [
              _colorPallet(),
              MyButton(
                label: widget.task == null ? "Create Tugas" : "Update Tugas",
                onTap: () => _validateData(),
              ),
            ],
          )
